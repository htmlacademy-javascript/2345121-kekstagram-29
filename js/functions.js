...
const palindrom = value => {
  ...
  let sum = Math.floor((secondLetter / 2) - 1);
  ...
  while (firstLetter < sum) {
    ...
    let firstHalfOfString = (value.slice(firstLetter, firstLetter +1));

    let secondHalfOfString = (value.slice(secondLetter, secondLetter +1));
